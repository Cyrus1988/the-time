...
<script src="{{ asset('/back//vendor/metisMenu/metisMenu.js')}}"></script>
<script src="{{ asset('/back//vendor/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
<script src="{{ asset('/back//vendor/jquery-sparkline/js/jquery.sparkline.min.js')}}"></script>
<script src="{{ asset('/back//vendor/bootstrap-progressbar/js/bootstrap-progressbar.min.js')}}"></script>
<script src="{{ asset('/back//vendor/chartist/js/chartist.min.js')}}"></script>
<script src="{{ asset('/back//vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.min.js')}}"></script>
<script src="{{ asset('/back//vendor/chartist-plugin-axistitle/chartist-plugin-axistitle.min.js')}}"></script>
<script src="{{ asset('/back//vendor/chartist-plugin-legend-latest/chartist-plugin-legend.js')}}"></script>
<script src="{{ asset('/back//vendor/toastr/toastr.js')}}"></script>
<script src="{{ asset('/back//scripts/common.js')}}"></script>
<script>
    $(function() {
        ...
        toastr['info']('Hello, welcome to DiffDash, a unique back dashboard.');
